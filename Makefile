...
SRC_QUERY = server/headers/query.c
...
$(OUTPUT_SERVER): $(SRC_SERVER) $(SRC_QUERYUSER) $(SRC_USER)
	$(CC) -pthread -o $(OUTPUT_SERVER) $(SRC_SERVER) $(SRC_QUERYUSER) $(SRC_QUERYCINEMA) $(SRC_QUERYPREMIEREDTIME) $(SRC_QUERYPREMIEREDTIMEFILM) $(SRC_QUERY) $(SRC_CATEGORY) $(SRC_CINEMA) $(SRC_FILM) $(SRC_MESSAGE) $(SRC_PREMIEREDTIME) $(SRC_PREMIEREDTIMEFILM) $(SRC_ROOM) $(SRC_SEAT) $(SRC_SOCKET) $(SRC_TICKET) $(SRC_USER) $(SRC_QUERYFILM) $(SRC_QUERYCATEGORY) $(SRC_FUNCTION_SERVER) -I/opt/homebrew/Cellar/mysql/8.2.0_1/include -L/opt/homebrew/Cellar/mysql/8.2.0_1/lib -lmysqlclient
